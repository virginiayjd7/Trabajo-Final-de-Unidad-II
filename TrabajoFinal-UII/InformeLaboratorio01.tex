...
\begin{itemize}
  ...
  \end{itemize}
\subsection{Instalar MongoDB}
\begin{itemize}
		\item Para instalar MongoDB primero tenemos que ejecutar el siguiente codigo.
                     \begin{center}
		\includegraphics[width=8cm]{./Imagenes/6}
		\end{center}	
		\item Vamos a elegir la versión de Community Server
		\item Seleccionamos Windows.Elegimos la versión Windows Server 2008 R2 64-bits and later, with SSL support x64
                     \item MongoDB está preparado para escalar fácilmente de manera horizontal
                     \begin{center}
